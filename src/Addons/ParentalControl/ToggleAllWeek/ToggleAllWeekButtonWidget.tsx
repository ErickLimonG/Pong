...
const daysTableString = PARENT_CONTROL_FORM + " " + "div:first-child > table:nth-of-type(2) tr:nth-of-type(2)"

class ToggleAllWeekWidget implements Widget {
    readonly destinationQuery = PARENT_CONTROL_FORM + " " + "div:first-child > table:nth-of-type(2) tr:nth-of-type(2)" + " th:first-child"
